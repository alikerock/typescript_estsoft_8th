...
// 타입 AppStatus에서 success, error 속성만 추출하여 타입 OnlySuccessOrError 생성
type OnlySuccessOrError = Extract<AppStatus, 'success' | 'error'>

// 타입 AppStatus에서 로딩 상태만 제외하여 타입 ExcludeLoading 생성
type ExcludeLoading = Exclude<AppStatus, 'loading'>;